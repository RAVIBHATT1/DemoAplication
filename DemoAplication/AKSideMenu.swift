...
@IBDesignable open class AKSideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    public var panMinimumOpenThreshold: Float = 40.0
    ...
    func commonInit() {
        ...
        self.panMinimumOpenThreshold = 40.0
        ...
        self.contentViewInLandscapeOffsetCenterX = 50.0
        self.contentViewInPortraitOffsetCenterX  = 50.0
        self.contentViewScaleValue = 1.0
        
        //for the  style chnage
        ///self.contentViewScaleValue = 1.0
    }
    ...
    func showLeftMenuViewController() {
        ...
        UIView.animate(withDuration: self.animationDuration, animations: {
           ...
           // self.contentViewContainer.center = CGPoint(x: (UIInterfaceOrientation.isLandscape(UIApplication.shared.statusBarOrientation) ? self.contentViewInLandscapeOffsetCenterX + self.view.frame.width : self.contentViewInPortraitOffsetCenterX + self.view.frame.width), y: self.contentViewContainer.center.y)
    ...
    func showRightMenuViewController() {
        ...
        UIView.animate(withDuration: self.animationDuration, animations: {
          ...
          //  self.contentViewContainer.center = CGPoint(x: (UIInterfaceOrientation.isLandscape(UIApplication.shared.statusBarOrientation) ? -self.contentViewInLandscapeOffsetCenterX : -self.contentViewInPortraitOffsetCenterX), y: self.contentViewContainer.center.y)
    ...
    override open func willAnimateRotation(to toInterfaceOrientation: UIInterfaceOrientation, duration: TimeInterval) {
        if self.visible {
          ...
          //      center = CGPoint(x: (UIDeviceOrientation.isLandscape(UIDevice.current.orientation) ? self.contentViewInLandscapeOffsetCenterX + self.view.frame.width : self.contentViewInPortraitOffsetCenterX + self.view.frame.width), y: self.contentViewContainer.center.y)
            } else {
           //     center = CGPoint(x: (UIDeviceOrientation.isLandscape(UIDevice.current.orientation) ? -self.contentViewInLandscapeOffsetCenterX : -self.contentViewInPortraitOffsetCenterX), y: self.contentViewContainer.center.y)
            }
